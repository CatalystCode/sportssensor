...
#########################################
#
# Prep to align left-right foot readings
　
########################################
getwd()
...
#cludge, new pair interval identified based on manual inspection 
...
############################################
#
#Clean out rows without matching pair of observations between feet
#
##########################################
　
